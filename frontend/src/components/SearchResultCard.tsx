...
const SearchResultCard = ({ hotel }: Props) => {
  return (
    <div className="grid grid-cols-1 xl:grid-cols-[2fr_3fr] border border-slate-300 rounded-lg p-3 gap-4">
        ...
        <div className="flex flex-col gap-4 xl:grid xl:grid-rows-[1fr_2fr_1fr]">
            <div> 
            <div className="flex items-center">
                <span className="flex">
                    { Array.from({ length: hotel.starRating }).map( (_u,i) => (
                        <AiFillStar key={i} className="fill-yellow-300" />
                    ) ) }
                </span>
            ...
            <div className="grid md:grid-cols-2 gap-2 md:items-end whitespace-nowrap">
                <div className="flex flex-wrap md:flex-nowrap items-start md:flex-row gap-1 md:items-center">
                ...
                <div className="flex flex-col  items-end gap-1">
                    <span className="font-bold text-sm">TND {hotel.pricePerNight} per night</span>
